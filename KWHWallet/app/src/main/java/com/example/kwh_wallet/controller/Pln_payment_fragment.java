...
public class Pln_payment_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.pln_payment_fragment, container, false);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                nominal = view.findViewById(R.id.nomimal);
